...
class TabCustom extends StatefulWidget {
  ...
  @override
  State<TabCustom> createState() => TabCustomState();
}

class TabCustomState extends State<TabCustom> with AutomaticKeepAliveClientMixin {
  @override
  bool get wantKeepAlive => true;

  final ProdutoState state = ProdutoState([]);

  void listarProdutos(categoria) async {
    state.listarProdutos(categoria);
  }
              ...
              return Card(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    ...
                    Navigator.pushNamed(context, "/cardapio/produto/${widget.tipo}/${widget.idComanda}", arguments: item);
                  },
