                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        if (opcoesPacote.id == 8 || opcoesPacote.id == 5) ...[
                          Checkbox(
                        ...
                        children: [
                          IconButton(
                            ...
                            icon: Icon(
                              ...
                              size: 30,
                              color:
                                  _provedorProduto.retornarDadosPorID([opcoesPacote.id]).firstWhere((element) => element.id == item.id).quantidade == 1 ? Colors.grey : Colors.red,
                            ),
                          ),
                          Text(
